...
const About = () => {
    return (
        <div>
            <section className="mb-5" id="aboutServ">
                <Container>
                    <Row>
                        <Col className="sm-12 text-center">
                            ...
                            <div className="carText2Div text-center mt-3">
                                <div>
                                    <h1 className="display-4" data-aos="fade-right" data-aos-offset="200" data-aos-delay="400" data-aos-duration="1000">About Us</h1>
                                </div>
